...
컴포넌트,역할,포트
1.Prometheus,메트릭 수집 및 경고 규칙 평가,9090

2.Alertmanager,경고 라우팅 및 Jenkins Webhook 전송,9093

3.Grafana,수집된 메트릭 시각화 (대시보드),3000

4.Node Exporter,OpenStack 노드의 시스템 메트릭 수집,9100

5.Jenkins,자동 조치(AutoHealingJob) 실행,8080
